    ...
    <tbody>
        <tr>
            <th class="form-group">
                <label for="nombreParticipante" class="text-white">
                    <i class="fas fa-user"></i> Nombre de participante (<i class="fa-solid fa-asterisk fa-2xs"></i>):
                </label>
        ...
        <tr>
            ...
            <th class="form-group">
                ...
                <input type="text" class="form-control" name="rutPartc" id="rutPartc" maxlength="13" placeholder="Ingresa su Rut">
            </th>
        </tr>
        <tr>
            <th class="form-group">
        ...
        <tr>
            ...
            <th class="form-group">
                <label for="vivePartc" class="text-white">
                    <i class="fas fa-users"></i> Con quién vive:
                </label>
