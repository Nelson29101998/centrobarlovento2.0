...
if (!isset($_SESSION["usuario"]) && !isset($_SESSION["rut"])) {
    ...
    include_once "../../../../conectarSQL/conectar_SQL.php";
        ...
        $actualizarSqlBanco = "UPDATE bancoprofesor set 
        banco='" . $nomBancoPro . "', tipo='" . $tipoBancoPro . "', codigoTipo='" . $codigotipoBancoPro . "',
        nombre='" . $nomRealBancoPro . "', rut='" . $rutBancoPro . "', mail='" . $mailBancoPro . "', observaciones='" . $obsBancoPro . "'
        WHERE idRut='".$buscarIdRut."'";    
?>
    ...
    <body>
        <?php
        if (($conexion->query($actualizarSqlBanco) === TRUE)) {
            echo "<br>
            <center>
