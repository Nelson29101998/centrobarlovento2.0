...
if (!isset($_SESSION["usuario"]) && !isset($_SESSION["rut"])) {
    ...
    include_once "../../../../conectarSQL/conectar_SQL.php";
        ...
        $actualizarSqlDatos = "UPDATE profesor set 
        nombre='" . $nomPro . "', nacimiento='" . $nacePro . "', rut='" . $rutPro . "', 
        telefono='" . $telPro . "', mail='" . $correoPro . "', direccion='" . $dirPro . "',
        areaDocente='" . $areaPro . "', otroDato='" . $otroPro . "'
        WHERE rut='" . $rutPro . "'";
...
?>
    ...
    <body>
        <?php
        if (($conexion->query($actualizarSqlDatos) === TRUE)) {
            echo "<br>
            <center>
